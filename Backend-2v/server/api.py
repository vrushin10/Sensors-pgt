...
templates = Jinja2Templates(directory="server/dist")

cred = firebase_admin.credentials.Certificate(
    "./server/bullet-detection-vest-firebase-adminsdk-a8mkk-8874ac4eb9.json")
...
app.mount("/assets", StaticFiles(directory="server/dist/assets"), name="assets")
app.mount("/", StaticFiles(directory="server/dist"), name="")